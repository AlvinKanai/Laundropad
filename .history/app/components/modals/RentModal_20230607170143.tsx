...
const RentModal = () => {
    ...
    const bathroomCount = watch('guestCount')
    ...
    if (step===STEPS.INFO){
        bodyContent = (
            <div className="flex flex-com gap-8">
                ...
                <hr />
                <Counter title="Rooms" subtitle="How many rooms do you have?" value={guestCount} onChange={(value) => setCustomValue('guestCount', value)} />
                <hr />
                <Counter title="Bathrooms" subtitle="How many bathrooms do you have?" value={guestCount} onChange={(value) => setCustomValue('guestCount', value)} />
                <hr />
